...
function crearUsuario() {
   ...
   //M06 JavaScript Objetos/test   // Además, esta clase debe tener un método llamado "saludar".
...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function(){
      ...
      for (let i= this.length-1; i >= 0; i--) {
         revertido.push(this.charAt(i));
      }

      for (let i = 0; i < revertido.length; i++) {
         sumandoArreglo += revertido[i];
      }

      return sumandoArreglo;
   }
}
